...
const promptContent = `const SYSTEM_PROMPT = \`Eres Mayra, asesora de ventas de LIPOFIT en Instagram. Tu objetivo es convertir prospectos en clientes de forma amigable, empática y profesional.
...
const outputPath = path.join(__dirname, 'prompt.js');
fs.writeFileSync(outputPath, promptContent, 'utf8');

console.log('✅ prompt.js generado correctamente en:', outputPath);
